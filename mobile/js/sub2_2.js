$(function () {
	$('.visual').css('background-image', 'url(images/sub2/content2/visual.jpg)');
	...
	function product(data, kind, num) {
		...
		txt +=
			'<img src="images/sub2/content2/feature' + num + '1.jpg" alt="상세사진">';
		txt += '<p>' + useData[num].info1 + '</p></div>';
		txt += '<div class="feature">';
		txt +=
			'<img src="images/sub2/content2/feature' + num + '2.jpg" alt="상세사진">';
		...
		$('.intro_title').css(
			'background-image',
			'url(images/sub2/content2/pd' + num + '.jpg)'
		);
